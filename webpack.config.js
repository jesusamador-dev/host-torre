...
const remoteHost = process.env.REACT_APP_DASHBOARDS_HOST_REMOTE ?? "https://portal.kairosportaldev.com.mx/";
...
const dashboardsSolicitudesEntryPath = `mf_mesacyc_dashboards_solicitudes@${remoteSolicitudes}dashboards/solicitudes/v1`;

const reactCoreRemoteEntryFileName = 'reactCoreRemoteEntry.js';
const selfRemoteEntryFileName = 'dashboardsEntry.js';
const contextOutputPath = 'dashboards/v1/';
module.exports = {
  output: {
    publicPath: `${remoteHost}${contextOutputPath}`,
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      name: 'mf_mesacyc_dashboards_host',
      ...
      remotes: {
        ...
        mf_mesacyc_dashboards_solicitudes: `${dashboardsSolicitudesEntryPath}/${selfRemoteEntryFileName}`
      },
      exposes: {
      },
      shared: {
